...
import {
  ...
  KanbanSquare, History, Package, FileText, LogOut, Target, X, ReceiptText, FileSignature,
} from 'lucide-react'
...
export default function Sidebar({ mobileOpen = false, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 flex h-screen w-64 flex-col border-r border-paper-line bg-white transition-transform duration-200 lg:static lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-between px-5 py-5">
          ...
          <button onClick={onClose} className="rounded-lg p-1.5 text-ink-faint hover:bg-paper lg:hidden">
            <X size={18} />
          </button>
        </div>
